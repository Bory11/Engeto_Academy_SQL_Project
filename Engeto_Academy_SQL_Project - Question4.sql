...
SELECT 
	...
	round(avg(vas.avg_wage) - lag(avg(vas.avg_wage)) OVER (ORDER BY vas.payroll_year), 2) AS YoY_wage_difference,
...
SELECT
	...
	avg_wage,
	avg_wage_prev_year,
	avg_wage - avg_wage_prev_year AS YoY_wage_difference,
	round((avg_wage - avg_wage_prev_year) / avg_wage_prev_year*100, 2) AS YoY_wage_difference_percentual,
	avg_price,
	avg_price_prev_year,
	avg_price - avg_price_prev_year AS YoY_price_difference,
